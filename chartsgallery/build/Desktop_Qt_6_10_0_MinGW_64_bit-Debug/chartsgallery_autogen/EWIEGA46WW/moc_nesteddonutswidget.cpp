...
namespace {
struct qt_meta_tag_ZN18NestedDonutsWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto NestedDonutsWidget::qt_create_metaobjectdata<qt_meta_tag_ZN18NestedDonutsWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<NestedDonutsWidget, qt_meta_tag_ZN18NestedDonutsWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject NestedDonutsWidget::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18NestedDonutsWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18NestedDonutsWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18NestedDonutsWidgetE_t>.metaTypes,
    nullptr
} };
...
void *NestedDonutsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18NestedDonutsWidgetE_t>.strings))
