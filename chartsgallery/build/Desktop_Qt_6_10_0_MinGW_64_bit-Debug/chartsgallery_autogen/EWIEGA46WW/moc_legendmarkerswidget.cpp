...
namespace {
struct qt_meta_tag_ZN19LegendMarkersWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto LegendMarkersWidget::qt_create_metaobjectdata<qt_meta_tag_ZN19LegendMarkersWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'disconnectMarkers'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'handleMarkerClicked'
    ...
    return QtMocHelpers::metaObjectData<LegendMarkersWidget, qt_meta_tag_ZN19LegendMarkersWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject LegendMarkersWidget::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19LegendMarkersWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19LegendMarkersWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19LegendMarkersWidgetE_t>.metaTypes,
    nullptr
} };
...
void *LegendMarkersWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19LegendMarkersWidgetE_t>.strings))
