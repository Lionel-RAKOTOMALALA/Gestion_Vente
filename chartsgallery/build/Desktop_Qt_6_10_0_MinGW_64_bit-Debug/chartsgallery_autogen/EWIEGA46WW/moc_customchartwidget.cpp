...
template <> constexpr inline auto CustomChartWidget::qt_create_metaobjectdata<qt_meta_tag_ZN17CustomChartWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<CustomChartWidget, qt_meta_tag_ZN17CustomChartWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject CustomChartWidget::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17CustomChartWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17CustomChartWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN17CustomChartWidgetE_t>.metaTypes,
    nullptr
} };
...
void *CustomChartWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17CustomChartWidgetE_t>.strings))
